...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": Ativar ordenação ascendente",sSortDescending:": Ativar ordenação descendente"},oPaginate:{sFirst:"Primeiro",sLast:"Último",sNext:"Próximo",sPrevious:"Anterior"},
sEmptyTable:"Nenhum resultado disponível",sInfo:"Mostrando de _START_ a _END_ de _TOTAL_ resultados",sInfoEmpty:"Mostrando 0 resultados",sInfoFiltered:"(Filtrados de _MAX_ resultados possíveis)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ resultados",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum resultado encontrado"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
